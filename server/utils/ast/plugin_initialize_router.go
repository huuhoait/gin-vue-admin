...
// PluginInitializeRouter PlugininitializeRoute
...
type PluginInitializeRouter struct {
	...
	ImportGlobalPath     string // GuidePackageGlobalVariablepath
	ImportMiddlewarePath string // GuidePackageInIntervalpiecepath
