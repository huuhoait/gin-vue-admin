...
func TestPackageEnter_Rollback(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "testExampleApiGrouprollback",
			fields: fields{
				...
				ImportPath:        `"github.com/huuhoait/gin-vue-admin/server/api/v1/example"`,
		...
		{
			name: "testExampleRouterGrouprollback",
			fields: fields{
				...
				ImportPath:        `"github.com/huuhoait/gin-vue-admin/server/router/example"`,
				StructName:        "Example",
				PackageName:       "example",
		...
		{
			name: "testExampleServiceGrouprollback",
			fields: fields{
				...
				ImportPath:        `"github.com/huuhoait/gin-vue-admin/server/service/example"`,
...
func TestPackageEnter_Injection(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "testExampleApiGroupinject",
			fields: fields{
				Type:              TypePackageApiEnter,
				Path:              filepath.Join(global.GVA_CONFIG.AutoCode.Root, global.GVA_CONFIG.AutoCode.Server, "api", "v1", "enter.go"),
				ImportPath:        `"github.com/huuhoait/gin-vue-admin/server/api/v1/example"`,
		...
		{
			name: "testExampleRouterGroupinject",
			fields: fields{
				Type:              TypePackageRouterEnter,
				Path:              filepath.Join(global.GVA_CONFIG.AutoCode.Root, global.GVA_CONFIG.AutoCode.Server, "router", "enter.go"),
				ImportPath:        `"github.com/huuhoait/gin-vue-admin/server/router/example"`,
		...
		{
			name: "testExampleServiceGroupinject",
			fields: fields{
				Type:              TypePackageServiceEnter,
				Path:              filepath.Join(global.GVA_CONFIG.AutoCode.Root, global.GVA_CONFIG.AutoCode.Server, "service", "enter.go"),
				ImportPath:        `"github.com/huuhoait/gin-vue-admin/server/service/example"`,
