...
func (*AliyunOSS) UploadFile(file *multipart.FileHeader) (string, string, error) {
	...
	// UploadAlibaba Cloudpath file nameFormat you may change keep unique names recommended
...
func (*AliyunOSS) DeleteFile(key string) error {
	...
	// deleteSingleFile. objectNameTableShowdeleteOSSFileWhenNeedSpecifyPackageIncludeFileAfterSuffixAtInsideofCompleteArrangepath, For exampleabc/efg/123.jpg. 
	// Such AsNeeddeleteFileclip, PleaseWillobjectNamesetForCorrespondingFileclipname. IfFileclipNot Null, ThenNeedWillFileclipDownofAllobjectdeleteAfterCan ThendeleteThisFileclip. 
