...
// Create creates a code generator history record
...
// First retrieves code generator history data by ID
// Author [SliverHorn](https://github.com/SliverHorn)
// Author [songzhibin97](https://github.com/songzhibin97)
func (s *autoCodeHistory) First(ctx context.Context, info common.GetById) (string, error) {
	...
	if err != nil {
		return "", errors.Wrap(err, "retrieval failed!")
	}
	return meta, nil
}

// Repeat checks for duplicates
// Author [SliverHorn](https://github.com/SliverHorn)
// Author [songzhibin97](https://github.com/songzhibin97)
...
// RollBack rolls back generated code
// Author [SliverHorn](https://github.com/SliverHorn)
// Author [songzhibin97](https://github.com/songzhibin97)
func (s *autoCodeHistory) RollBack(ctx context.Context, info request.SysAutoHistoryRollBack) error {
	...
	for key, value := range history.Injections {
		...
		if file != nil {
			...
			fmt.Printf("[filepath:%s]injection code rollback succeeded!\n", key)
		}
	} // Clear injected code
	...
	for _, value := range history.Templates {
		...
		if err != nil {
			return errors.Wrapf(err, "[src:%s][dst:%s]failed to move file!", value, removePath)
		}
	} // Move files
...
// GetList retrieves system history data
// Author [SliverHorn](https://github.com/SliverHorn)
// Author [songzhibin97](https://github.com/songzhibin97)
