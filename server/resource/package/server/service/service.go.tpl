...
// Get{{.StructName}}InfoList add search statements
       {{ GenerateSearchConditions .Fields }}
// Get{{.StructName}}InfoList add sort statements. Add orderMap entries to the search statement yourself
       {{- range .Fields}}
            {{- if .Sort}}
...
{{- if .HasDataSource }}
// Add data-source join statements to Get{{.StructName}}DataSource()
...
{{- if not .OnlyTemplate }}
// Create{{.StructName}} Create a {{.Description}} record
...
// Delete{{.StructName}} Delete a {{.Description}} record
// Author [yourname](https://github.com/yourname)
...
// Delete{{.StructName}}ByIds Batch delete {{.Description}} records
// Author [yourname](https://github.com/yourname)
...
// Update{{.StructName}} Update a {{.Description}} record
// Author [yourname](https://github.com/yourname)
...
// Get{{.StructName}} Get a {{.Description}} record by {{.PrimaryField.FieldJson}}
// Author [yourname](https://github.com/yourname)
...
{{- if .IsTree }}
// Get{{.StructName}}InfoList Paginated {{.Description}} records. In tree mode, pagination and search are not applied
// Author [yourname](https://github.com/yourname)
...
{{- else }}
// Get{{.StructName}}InfoList Paginated {{.Description}} records
// Author [yourname](https://github.com/yourname)
func ({{.Abbreviation}}Service *{{.StructName}}Service)Get{{.StructName}}InfoList(ctx context.Context, info {{.Package}}Req.{{.StructName}}Search) (list []{{.Package}}.{{.StructName}}, total int64, err error) {
	...
	db := {{$db}}.Model(&{{.Package}}.{{.StructName}}{})
    var {{.Abbreviation}}s []{{.Package}}.{{.StructName}}
    // Search clauses are generated automatically below when conditions are present
{{- if .GvaModel }}
...
func ({{.Abbreviation}}Service *{{.StructName}}Service)Get{{.StructName}}Public(ctx context.Context) {
    // This method returns the data defined for the data source
