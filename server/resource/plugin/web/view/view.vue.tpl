...
<template>
  ...
  {{- end }}
    <div class="gva-table-box">
        ...
        {{- end }}
        {{- end }}
        <el-table-column align="left" label="Actions" fixed="right" min-width="240">
    ...
    <el-drawer destroy-on-close size="800" v-model="detailShow" :show-close="true" :before-close="closeDetailShow" title="View">
