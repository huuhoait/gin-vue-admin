...
// Labels go through `t()` inside a computed so locale switches propagate.
const layoutModes = computed(() => [
  {
    value: 'normal',
    label: t('admin.layout.settings.layout_modes.normal.label'),
    description: t('admin.layout.settings.layout_modes.normal.description'),
    containerClass: '',
    showSidebar: true,
    sidebarClass: 'w-1/4',
    showHeader: true,
  ...
  {
    value: 'head',
    label: t('admin.layout.settings.layout_modes.head.label'),
    description: t('admin.layout.settings.layout_modes.head.description'),
  ...
  {
    value: 'combination',
    label: t('admin.layout.settings.layout_modes.combination.label'),
    description: t('admin.layout.settings.layout_modes.combination.description'),
    containerClass: '',
    showSidebar: true,
    sidebarClass: 'w-1/5',
    showHeader: true,
  ...
  {
    value: 'sidebar',
    label: t('admin.layout.settings.layout_modes.sidebar.label'),
    description: t('admin.layout.settings.layout_modes.sidebar.description'),
    containerClass: '',
    showSidebar: true,
    sidebarClass: 'w-1/3',
    showHeader: true,
