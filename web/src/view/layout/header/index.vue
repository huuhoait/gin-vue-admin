    ...
    <div class="flex items-center cursor-pointer flex-1">
      ...
      >
        <el-breadcrumb-item
          ...
          :key="item.path"
        >
          {{ fmtTitle($t(item.meta.title), route) }}
        </el-breadcrumb-item>
      </el-breadcrumb>
      <gva-aside
          ...
          <el-dropdown-menu>
            <el-dropdown-item>
              <span class="font-bold">
                {{ t('admin.layout.header.current_role') }}: {{ userStore.userInfo.authority.authorityName }}
              </span>
            </el-dropdown-item>
            <template v-if="userStore.userInfo.authorities">
              ...
              >
                <span>{{ t('admin.layout.header.switch_to') }}: {{ item.authorityName }}</span>
              </el-dropdown-item>
            </template>
            <el-dropdown-item icon="avatar" @click="toPerson">
              {{ t('admin.layout.header.profile') }}
            </el-dropdown-item>
