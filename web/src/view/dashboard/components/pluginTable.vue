<template>
  <div>
    <el-table :data="tableData" stripe style="width: 100%">
      <el-table-column prop="name" label="Plugin" show-overflow-tooltip width="200">
      ...
      <el-table-column prop="resume" label="Summary" show-overflow-tooltip></el-table-column>
      <el-table-column prop="money" label="Price" width="100">
        <template #default="{ row }">
          <span v-if="row.money === 0">Free</span>
