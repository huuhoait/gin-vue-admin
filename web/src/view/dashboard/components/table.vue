<template>
  <div>
    <el-table :data="tableData" stripe style="width: 100%">
      <el-table-column prop="ranking" label="Rank" width="80" align="center" />
      <el-table-column prop="message" label="Changes" show-overflow-tooltip />
...
<script setup>
  ...
  const Commits =(page) => {
   return service({
    url:
      'https://api.github.com/repos/huuhoaitvn/gin-vue-admin/commits?page=' +
      page,
    method: 'get'
  })
}
