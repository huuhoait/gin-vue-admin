<template>
  <div class="h-full space-y-5">
    <div>
      <div class="mb-2 text-xs tracking-wide text-black/55 dark:text-white/55">Shortcuts</div>
    ...
    <div>
      <div class="mb-2 text-xs tracking-wide text-black/55 dark:text-white/55">External links</div>
      <div class="space-y-2">
        <button
        ...
        >
          ...
          <span class="text-xs text-black/45 dark:text-white/45">Open</span>
        </button>
      </div>
    </div>
  </div>
...
<script setup>
  ...
  const shortcuts = [
    { icon: Menu, title: 'Menu', path: 'menu' },
    { icon: Link, title: 'API', path: 'api' },
    { icon: Service, title: 'Roles', path: 'authority' },
    { icon: User, title: 'Users', path: 'user' },
    { icon: Files, title: 'Auto package', path: 'autoPkg' },
    { icon: Memo, title: 'Auto code', path: 'autoCode' }
  ]
